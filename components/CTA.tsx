...
const CTA = () => {
  return (
    <div className='max-w-[1440px] mx-auto sm:px-16 px-6 py-10'>
        <h2 className='sm:px-10 text-headline-2 text-center text-primary m-5'> Work <span className='text-secondary '>smarter </span> not <span className='text-secondary'>harder </span>- start your journey with us.</h2> 
