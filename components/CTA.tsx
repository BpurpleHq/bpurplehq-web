...
const CTA = () => {
  return (
    <div className='max-w-[1440px] mx-auto bg-white sm:px-16 px-6 py-10'>
        <h2 className='sm:px-10 text-center text-primary m-5 lg:text-headline-2 text-headline-3 text-4xl md:text-5xl font-bold text-gray-900 leading-tight'> Work Smarter not Harder</h2> 
