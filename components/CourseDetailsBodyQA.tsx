  ...
  return (
    <div className='max-w-[1440px] mx-auto flex flex-col sm:px-16 px-6 lg:py-10 py-4'>
        ...
        <div className='mt-4'>
            ...
            <p className='text center mt-2'> - Quality Assurance Foundations: The course will provide a solid foundation in software testing methodologies, test planning, and quality assurance best practices. <br/>
            - Test Automation Frameworks: Participants will learn how to design and implement test automation frameworks to streamline testing processes and improve test coverage. <br/>
            - Test Reporting and Analysis: The training will include strategies for generating insightful test reports and analyzing test results to identify issues effectively.<br/>
            - Debugging and Troubleshooting: Participants will acquire skills in debugging automated tests and identifying root causes of failures.<br/>
            - API, Web and Mobile Testing: Participants will explore automated testing techniques for web and mobile applications, including web services/API testing.<br/>
            <br/>
             Throughout the training, participants will engage in hands-on exercises and real-world projects that simulate software testing scenarios. 
            By applying their knowledge in practical settings, they will gain the confidence and competence to address testing challenges in their 
