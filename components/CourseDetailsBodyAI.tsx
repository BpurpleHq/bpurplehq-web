  ...
  return (
    <div className='max-w-[1440px] mx-auto flex flex-col sm:px-16 px-6 lg:py-10 py-4'>
       ...
       {/** <div>
            ...
            <p className='text center mt-2'>AI has become a critical capability for organizations seeking to thrive in a data-rich world. By leveraging advanced techniques and tools, businesses can unlock the hidden potential within their data, gaining valuable insights to inform decision-making, drive innovation, and gain a competitive advantage.</p>
        </div> **/}

        <div className='mt-4 sm:px-16 px-6 lg:py-10 py-4'>
            <h3 className='text-center text-primary text-headline-2'>COMING SOON!!</h3>
...
<h4 className='text-primary text-headline-4'>Data Cleaning and Preprocessing:</h4> - Ensuring data quality by identifying and addressing errors, inconsistencies, missing values, and outliers. This step involves data cleansing, standardization, and transformation.<br/> 
<h4 className='text-primary text-headline-4'>Exploratory Data Analysis (EDA):</h4> Conducting initial data exploration to understand the characteristics, distributions, and relationships within the data. EDA involves generating summary statistics, creating visualizations, and identifying patterns or trends.<br/>
...
- Data Visualization: Presenting data visually through charts, graphs, and interactive dashboards to communicate findings effectively and facilitate better understanding.</p> **/}
          ...
          {/** URL - https://forms.gle/ubN1UipLdP3oUcCj8 -- 
