...
const Products = () => {
  return (
    <div className='sm:px-16 px-6 py-10'>
      <h2 className='text-headline-3 lg:text-headline-2 text-primary text-center'>What We Do at bpurpleHQ</h2>
      <p className='lg:text-headline-4 lg:text-center mt-2'>At bpurple, you gain access to project-based learning curriculum to enable you graps immediately the techniques involved in develop quality products.</p>
      <div className='py-10'>
        <Swiper
          // @ts-ignore
          ...
          {products.map(({id, image, title, description}) => (
            <SwiperSlide>
              <div className='flex flex-col lg:flex-row lg:justify-between'>
                <Image src={image} alt={title} width={400} height={300} className='border-2 border-primary rounded-xl' />
        ...
        <h3 className='text-headline-3 mt-7'>Testimonials</h3>
