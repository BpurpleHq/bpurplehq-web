        ...
        <section className='bg-extra'>
            <div className='max-w-[1440px] mx-auto flex flex-col-reverse lg:flex-row justify-between sm:px-16 px-6 lg:py-10 py-4'>
                <div className='mt-4 lg:mt-0'>
                    <h2 className='text-headline-3 text-center lg:text-start lg:text-headline-2 text-primary lg:w-[422px]'>Prepare and Empower your labor force for the future of work.</h2>
