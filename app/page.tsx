    ...
    <main className="w-full relative">
      <section className='bg-white lg:h-screen flex lg:flex-row flex-col gap-5 relative z-0 max-w-[1440px] mx-auto sm:px-16 px-3 pt-[40px] pb-7 lg:pb-0'>
        <div className='flex flex-col lg:justify-start lg:items-start lg:mt-[50px] w-full lg:max-w-[70%] flex-1'>
          <h1 className='lg:w-[70%] text-headline-2 text-primary'>Tech <span className='text-secondary'>Training,</span> Get Mentored and Consulting.</h1>
          ...
          <div className='flex justify-center items-center lg:justify-items-start gap-3 mt-[70px] md:mt-8'>
            <CustomButton
              ...
              textStyles='text-dark text-body-1 font-medium'
            />
            <CustomButton
              title='Enroll Now'
              btnType='button'
        ...
        <div className='hidden md:flex relative lg:w-[657px] lg:h-[509px] h-[390px] border-2 border-secondary rounded-xl'>
