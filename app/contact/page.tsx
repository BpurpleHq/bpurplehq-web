...
export default function Page() {
  ...
  return (
    <main className="relative w-full overflow-hidden">
      ...
      {/* Contact Form & Questions Section */}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent outline-none transition-all duration-300"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent outline-none transition-all duration-300 bg-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent outline-none transition-all duration-300 resize-none"
              ...
              <div className="grid grid-cols-1 gap-6">
                {questions.map(({ id, image, title, content }) => (
                  <motion.div
                    ...
                    className="bg-white border-2 border-purple-200 rounded-2xl p-6 hover:bg-gradient-to-br hover:from-purple-50 hover:to-lavender-50 hover:border-purple-400 hover:shadow-lg transition-all duration-300"
                  >
